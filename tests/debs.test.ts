...
describe('the package definitions', () => {
  test('every debs/<package> declares its architectures and has a control template named after it', () => {
    ...
    expect(Object.fromEntries(packages.map(entry => [entry.name, entry.version]))).toEqual({ 'mica-busybox': '1.38.0-mica1', 'mica-ca-trust': '20250419-mica2', 'mica-ssh': '1.0.0-2', 'mica-system': '1.1.0-1', 'mica-systemd-boot': '257.13-mica1', 'mica-tzdata': '2026c-mica1', 'mica-wifi': '2.12-mica1', 'mica-wifi-ap': '2.12-mica1' })
  })
